...
export interface Loader {
    (location: string, options: LoadOptions, callback: LoadCallback): any;
}
/**
 ...
 */
export declare type ProcessResponseCallback<T = any> = (res: Response, callback: ResponseCallback<T>) => void;
